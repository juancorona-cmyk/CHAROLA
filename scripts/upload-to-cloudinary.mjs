...
cloudinary.config({
  cloud_name: process.env.CHAROLA_CLOUD_NAME || process.env.PUBLIC_CHAROLA_CLOUD_NAME || process.env.CLOUDINARY_CLOUD_NAME,
  api_key:    process.env.CHAROLA_API_KEY || process.env.CLOUDINARY_API_KEY,
  api_secret: process.env.CHAROLA_API_SECRET || process.env.CLOUDINARY_API_SECRET,
  secure: true,
});
